...
if ( ! function_exists( 'acf_qtranslate_enabled' ) ) {
	...
	function acf_qtranslate_admin_enqueue_scripts() {
		wp_enqueue_style( 'acf_qtranslate_main', DECO_THEME_FRAMEWORK_URI . 'modules/acf/addons/acf-qtranslate/assets/main.css' );
		wp_enqueue_script( 'acf_qtranslate_main', DECO_THEME_FRAMEWORK_URI . 'modules/acf/addons/acf-qtranslate/assets/main.js' );
	}
