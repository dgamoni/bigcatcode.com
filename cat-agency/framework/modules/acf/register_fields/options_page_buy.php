...
if ( function_exists( "register_options_page" ) ) {
	...
	register_options_page( 'Настройки страницы покупки', $slug );
	...
	$fields[] = array(
		...
		'name'          => 'deco_buy_page_content_header',
	...
	$fields[] = array(
		'key'           => 'field_' . $id . '_' . ++ $i,
		'label'         => 'Надпись в блоке выбранного товара',
		'name'          => 'deco_buy_page_product_block_title',
	...
	$fields[] = array(
		'key'           => 'field_' . $id . '_' . ++ $i,
		'label'         => 'Надпись Заполните личные данные',
		'name'          => 'deco_buy_page_personal_info_text',
		'type'          => 'qtranslate_wysiwyg',
		'instructions'  => '',
		'required'      => '0',
		'default_value' => '',
	...
	$fields[] = array(
		'key'           => 'field_' . $id . '_' . ++ $i,
		'label'         => 'Надпись в скобках, о том что данные будут защищены',
		'name'          => 'deco_buy_page_personal_info_secured_text',
		'type'          => 'qtranslate_wysiwyg',
		'instructions'  => '',
		'required'      => '0',
		'default_value' => '',
	...
	$fields[] = array(
		'key'           => 'field_' . $id . '_' . ++ $i,
		'label'         => 'Надпись Выберите удобный способ оплаты',
		'name'          => 'deco_buy_page_text_choice_pay_method',
		'type'          => 'qtranslate_wysiwyg',
		'instructions'  => '',
		'required'      => '0',
		'default_value' => '',
	...
	$fields[] = array(
		'key'           => 'field_' . $id . '_' . ++ $i,
		'label'         => 'Надпись Совершение оплаты',
		'name'          => 'deco_buy_page_text_proccess_pay',
		'type'          => 'qtranslate_wysiwyg',
		'instructions'  => '',
		'required'      => '0',
		'default_value' => '',
